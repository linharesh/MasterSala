...
<html lang="en">
  <head>
    ...
    <title>Gerenciador de Salas - Sobre</title>
	...
	<div id="dg">
		<div class="container">
			<div class="row centered">
				...
				<h4>Qualquer dúvida, entrar em contato com a equipe através do email linhares.h@gmail.com</h4>
			</div><!-- row -->
		</div><!-- container -->
	</div><!-- DG -->
