...
import EnterpriseJavaBeans.SolicitacaoDeSalaBean;
...
public class SolicitarReservaSala extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("Professor/SalaReservadaComSucesso.jsp");
