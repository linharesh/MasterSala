...
import EnterpriseJavaBeans.LoginSessionBean;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (authBean.autentica(tipoDeUsuario, login, senha)) {           
                ...
                if (tipoDeUsuario.equalsIgnoreCase("GerenteDeRecursos")) {
                    requestDispatcher = request.getRequestDispatcher("gerenteDeRecursoLogado.jsp");
                }

                if (tipoDeUsuario.equalsIgnoreCase("Professor")) {
                    requestDispatcher = request.getRequestDispatcher("professorLogado.jsp");
                }

                if (tipoDeUsuario.equalsIgnoreCase("AssistenteDeRecursos")) {
                    requestDispatcher = request.getRequestDispatcher("assistenteDeRecursosLogado.jsp");
                }
